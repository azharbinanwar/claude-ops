---
description: Show the claude-ops cheat sheet — all commands at a glance
model: haiku
...
|---|---|
| /short | ≤2 lines, no code |
| /yn | Yes/No + one reason |
| /easy | Plain words, no jargon |
| /summary | ≤5 bullets |
| /cmd | Just the shell/git command |
...
| /explain | Brief explanation, no fix |
| /why | Root cause only |
